...
if (isset($_POST['submit'])) {
    ...
    $Status = 0;
    $SubCategories = htmlspecialchars($_POST['SubCategories']);
    ...
    owner_vehicle_name='$owner_vehicle_name', SubCategories='$owner_vehicle_brand',owner_vehicle_brand='$owner_vehicle_brand',owner_vehicle_chesis_no='$owner_vehicle_chesis_no',
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-9">
                ...
                <form action="" class="form-box2" method="post" name="booking" name="booking" id="booking">
                    ...
                    <!-- <a href="my_booking.php?id=<?php echo $rws['id'] ?>" class="submit-btn btn"
                        style="background-color: #1886bb;color: black" type="submit" name="submit" id="submit">Book</a> -->
