    ...
    <div class="col-sm-4" style="margin-bottom: 5px;margin-top: 2%;">
        <div class="form-box1">
            ...
            <form id="one" action="" method="post">
                ...
                <input type="text" class="form-control" value="<?php echo $pickup; ?>" aria-label="Username"
                    aria-describedby="basic-addon1" name="pickup" id="pickup">

                <label style="margin-top: 19px;" for=""> Dropping Off Location</label>
                <input type="text" class="form-control" value="<?php echo $dropoff; ?>" aria-label="Username"
                    aria-describedby="basic-addon1" name="dropoff" id="dropoff">

                <label style="margin-top: 19px;" for="">Picking Up Date</label>
                <input type="date" class="form-control" value="<?php echo $FromDate; ?>"
                    aria-label="Recipient's username" aria-describedby="basic-addon2" name="FromDate" id="FromDate">

                <label style="margin-top: 19px;" for="">Return Date</label>
                <input type="date" class="form-control" value="<?php echo $ToDate; ?>" aria-label="Recipient's username"
                    aria-describedby="basic-addon2" name="ToDate" id="ToDate">


                <label style="margin-top: 19px;" for="">Pick-up Time (Mandatory)</label>
                <input type="time" class="form-control" value="<?php echo $Time; ?>" aria-label="Username"
                ...
                <select class="form-control" placeholder="Select type" data-live-search="false" name="SeatingCapacity"
                    id="SeatingCapacity" aria-label="Username" aria-describedby="basic-addon1">
