          ...
          if (isset($_POST['register_submit'])) {
            ...
            $insert_qry = "INSERT INTO `tblbooking` (`UserName`,`email`,`number`,`password`,`confirm_password`)
    VALUES('$username','$email','$number','$password','$confirm_password')";
                ...
                <form class="w3-container" action="" method="post" name="signup_form" id="signup_form">
                  <div class="w3-section">
                    ...
                    <div>
                      ...
                      <input class="w3-input w3-border w3-margin-bottom" type="number" placeholder="Enter 10digit Mobile Number" name="number" id="number">
                    </div>
                    <div>
