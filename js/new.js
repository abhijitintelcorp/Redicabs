...
var grid = new ej.grids.Grid(
  {
    ...
    allowPaging: true,
    columns: [
      { field: 'UserName', headerText: 'Order ID', width: 120, textAlign: 'Right' },
      { field: 'EmailId', headerText: 'Customer Name', width: 150 },
      { field: 'COntactNo', width: 120, format: 'C2', textAlign: 'Right' }
    ],
