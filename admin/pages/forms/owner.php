...
if (isset($_POST['owner_submit'])) {
    ...
    $path1 = "image/" . $frontimage;
    $path2 = "image/" . $backimage;
    $path3 = "image/" . $DLimage;
    $path4 = "image/" . $Adharimage;
                                        ...
                                        <div class="card-body">
                                            <form action="" method="post" name="add_owner" id="add_owner"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter vehiclename" name="chasis"
                                                                id="chasis">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter Driver DL number" name="DLno"
                                                                id="DLno">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter seating capacity" name="seat"
                                                                id="seat">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter ownername" name="ownname"
                                                                id="ownname">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>ownwerNo</label>
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter owner number" name="ownno"
                                                                id="ownno">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="customFile">UploadDL</label>

                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    id="DLimage" name="DLimage">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="customFile">UploadAdharCard</label>

                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    id="Adharimage" name="Adharimage">
                                                                <label class="custom-file-label" for="customFile">Choose
                                                                    file</label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="customFile">FrontImage</label>

                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    id="frontimage" name="frontimage">
                                                                <label class="custom-file-label" for="customFile">Choose
                                                                    file</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="customFile">BackImage</label>

                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"
                                                                    id="backimage" name="backimage">
                                                                <label class="custom-file-label" for="customFile">Choose
                                                                    file</label>
                                                            </div>
                                                        </div>
