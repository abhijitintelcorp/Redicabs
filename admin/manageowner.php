                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <th><?php echo $row['VehicleRCnumber']; ?></th>
                                                <th><?php echo $row['VehicleChesisNumber']; ?></th>
                                                <th><?php echo $row['DriverName']; ?></th>
                                                <th><?php echo $row['DriverNumber']; ?></th>
                                                <th><?php echo $row['DriverDLNo']; ?></th>
                                                <th><?php echo $row['Price']; ?></th>
                                                <th><?php echo $row['seat']; ?></th>
                                                <th><?php echo $row['OwnerName']; ?></th>
                                                <th><?php echo $row['OwnerNumber'] ?></th>
                                                <th><img src="image/<?php echo $row['frontimage']; ?>" width="30"
                                                        height="30" alt=""></th>
                                                <th><img src="image/<?php echo $row['backimage']; ?>" width="30"
                                                        height="30" alt=""></th>
                                                <th><img src="image/<?php echo $row['DLimage']; ?>" width="30"
                                                        height="30" alt=""></th>
                                                <th><img src="image/<?php echo $row['Adharimage']; ?>" width="30"
                                                        height="30" alt=""></th>
                                                <th colspan="2">Action</th>
                                            </tr>
                                        </tbody>
