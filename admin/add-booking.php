...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        ...
        owner_email='$owner_email',DriverName='$DriverName',DriverMobile='$DriverMobile',FromDate='$FromDate',ToDate='$ToDate',
         ...
         BookingNumber='$bookingno',status='$status',dob='$dob',Time='$pickuptime',RegDate='$regdate',Driver_DL_No='$Driver_DL_No' WHERE id='$id'";
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <img src="images/<?php echo $rows['frontimage']; ?>" style="width:20%;" name="frontimage" id="frontimage">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <img src="images/<?php echo $rows['backimage']; ?>" style="width:20%;" name="backimage" id="backimage">
