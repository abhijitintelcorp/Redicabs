...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        ...
        DLimage,own_adhar_image,Driver_Adhar_image,Country)
        ...
        '$frontimage','$backimage','$DLimage','$own_adhar_image','$Driver_Adhar_image','$Country')";
                                ...
                                <div class="card card-warning">
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" name="add_booking" id="add_booking"
                                            ...
                                            <input type="hidden" name="SeatingCapacity"
                                                value="<?php echo $rows['SeatingCapacity'] ?>">
                                            <input type="hidden" name="Categories"
                                                value="<?php echo $rows['Categories'] ?>">
                                            ...
                                            <input type="hidden" name="Driver_Adhar_image"
                                                value="<?php echo $rows['Driver_Adhar_image'] ?>">
                                            <input type="hidden" name="own_adhar_image"
                                                value="<?php echo $rows['own_adhar_image'] ?>">
                                            <div class="row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Brand</label>
                                                        <input type="text" class="form-control"
                                                            placeholder="Enter subcategories" name="brand" id="brand"
                                                            value="<?php echo $rows['owner_vehicle_brand']; ?>"
                                                            readonly="readonly">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="vehicle_quantity"
                                                        id="vehicle_quantity" readonly="readonly"
                                                        value="<?php echo $row['counts']; ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" class="form-control"
                                                            placeholder="Enter modelyear" name="owner_id" id="owner_id"
                                                            value="<?php echo $rows['id']; ?>" readonly="readonly">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="submit"
                                            style="margin-left: 332px;">Book</button>
                                    </div>
                                </div>
