                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <form action="" method="post">
                                                    ...
                                                    <tr>
                                                        <th>Total Days</th>
                                                        <td><input type="text" class="form-control" name="TotalNoDays" id="TotalNoDays" value="<?php echo $row['TotalNoDays']; ?>" required>
                                                        </td>
                                                        <th>Rent Per Days</th>
                                                        <td><input type="text" class="form-control" name="PricePerDay" id="PricePerDay" onkeyup="add()" value="<?php echo  $row['PricePerDay']; ?>" required>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Phone Number</th>
                                                        <td>
                                                            <input class="form-control white_bg" placeholder="Owner Id" name="owner_id" id="owner_id" type="hidden" readonly="readonly" value="<?php echo $row['owner_id']; ?>">
                                                            <input class="form-control white_bg" placeholder="Owner Number" name="owner_mobile" id="owner_mobile" type="text" readonly="readonly" value="<?php echo $row['owner_mobile']; ?>">
                                                        </td>
                                                    </tr>
                                                    <?php   ?>
                                                    <tr>
                                                        ...
                                                        <td><input class="form-control white_bg" name="vehicle_quantity" id="vehicle_quantity" type="text" value="<?php echo $row['vehicle_quantity']; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th>Driver Name</th>
                                                        <td><select name="DriverName" id="DriverName" type="text" class="selectpicker">
                                                                <option value="<?php echo $row['DriverName']; ?>">
                                                                    <?php echo $row['DriverName']; ?></option>
                                                            </select>
                                                        </td>
                                                        <th>Phone Number</th>
                                                        <td><input class="form-control white_bg" placeholder="Driver Number" name="DriverMobile" id="DriverMobile" type="text" readonly="readonly" value="<?php echo $row['DriverMobile']; ?>"></td>

                                                    </tr>
                                                    <tr>
                                                        <th colspan="3" style="text-align:center">Grand Total</th>
                                                        <td><input type="text" class="form-control" name="total" id="total" readonly="readonly" value="<?php echo $row['TotalNoDays'] * $row['PricePerDay'] ?>" required>
                                                        </td>
                                                    </tr>
