                    ...
                    <div class="form-box row">
                        ...
                        <fieldset style="height: 560px;">
                            ...
                            <form class="text-center" id="booking" action="Search_car.php" method="post" name="booking">
                                ...
                                <input type="text" class="form-control" placeholder=" From (Area,Street,Landmark)" aria-label="Username" aria-describedby="basic-addon1" name="pickup" id="pickup" required>

                                <label for=""> Dropping Off Location</label>
                                <input type="text" class="form-control" placeholder="To(Area,Street, Landmark)" aria-label="Username" aria-describedby="basic-addon1" name="dropoff" id="dropoff" required>
                                <div class="row p-0 m-0">
                                    <div class="col-5 p-0">
                                        <label for="">Picking Up Date</label>
                                        <input type="date" class="form-control" placeholder="Pick-up Date" style="margin-left:20px;" name="FromDate" id="FromDate" required>
                                    </div>
                                    <div class="col-6 p-0">
                                ...
                                <input type="time" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="Time" id="Time" required>
                                <label for="">Select Vehicle Type</label>
                                <select class="form-control" data-live-search="false" name="Categories" id="Categories" required>
                                ...
                                <select class="form-control" placeholder="Select type" data-live-search="false" name="SeatingCapacity" id="SeatingCapacity" aria-label="Username" aria-describedby="basic-addon1" required>
                    ...
                    <div class="slider places-slider">
                        <div class="row">
                            <div class="slider-item">
                                <div id="slider1" class="slider-img" style="background-image:url('images/slider/DB.png'); background-size:auto;background-repeat:no-repeat;margin: 40px 40px;">
                        ...
                        <div class="row">
                            <div class="slider-item ">
                                <div id="slider2" class="slider-img" style="background-image:url('images/slider/Visakhapatnam.png'); background-size:auto;background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                        ...
                        <div class="row">
                            <div class="slider-item homepage-sllider-m">
                                <div id="slider3" class="slider-img" style="background-image:url('images/slider/Kurnool.png'); background-size:auto;background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                        ...
                        <div class="row">
                            <div class="slider-item ">
                                <div id="slider4" class="slider-img" style="background-image:url('images/slider/Amaravathi.png'); background-size:auto; background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                                <div class="slider-text-hover">
                                    <div class="slider-hover-content"></div>
                                    <div class="Orange">
                        ...
                        <div class="row">
                            <div class="slider-item">
                                <div id="slider5" class="slider-img" style="background-image:url('images/slider/NK.png'); background-size:auto;background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                                <div class="slider-text-hover">
                                    <div class="slider-hover-content"></div>
                                    <div class="Orange">
                        ...
                        <div class="row">
                            <div class="slider-item homepage-sllider-m">
                                <div id="slider6" class="slider-img" style="background-image:url('images/slider/Puri.png'); background-size:auto; background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                        ...
                        <div class="row">
                            <div class="slider-item ">
                                <div id="slider7" class="slider-img" style="background-image:url('images/slider/Sambalpur.png'); background-size:auto; background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                                <div class="slider-text-hover">
                                    <div class="slider-hover-content"></div>
                                    <div class="Orange">
                        ...
                        <div class="row">
                            <div class="slider-item ">
                                <div id="slider8" class="slider-img" style="background-image:url('images/slider/Vijayawada.png'); background-size:auto;background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                        ...
                        <div class="row">
                            <div class="slider-item homepage-sllider-m">
                                <div id="slider9" class="slider-img" style="background-image:url('images/slider/Tirupati.png'); background-size:auto;background-repeat:no-repeat; margin: 40px 40px;">
                                </div>
                                <div class="slider-text-hover">
                                    <div class="slider-hover-content"></div>
                                    <div class="Orange">
