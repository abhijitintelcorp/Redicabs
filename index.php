                        ...
                        <form id="booking" action="Search_car.php" method="post" name="booking">
                            ...
                            <div class="row p-0 m-0">
                                ...
                                <div class="col-6 p-0">
                                    ...
                                    <input type="date" class="form-control" placeholder="Pick-up Date"
                                        style="margin-left:20px;" name="ToDate" id="ToDate" required>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $("#booking").validate({
        ...
        messages: {
            ...
            Categories: {
                required: "<b style='color:red'>Please select your category</b>",
            },
            // VehicleName: {
            ...
            FromDate: {
                required: "<b style='color:red'>Please enter your pickup Date</b>",
            },
            ToDate: {
                required: "<b style='color:red'>Please enter your return Date</b>",
            },
            Time: {
                required: "<b style='color:red'>Please enter your Time of travel</b>",
            },
        },
        submitHandler: function(form) {
            form.submit();
